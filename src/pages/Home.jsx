  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-8">
        ...
        <div className="max-w-xs sm:max-w-md md:max-w-3xl mx-auto bg-gradient-to-r from-gray-700 via-gray-900 to-black bg-opacity-80 rounded-xl shadow-2xl p-6 sm:p-8">
          <p className="text-sm sm:text-lg text-white mb-6 leading-relaxed">
          ...
          <div className="bg-gradient-to-r from-gray-800 via-gray-800 bg-opacity-80 p-4 sm:p-6 rounded-lg shadow-md">
            <h2 className="text-2xl sm:text-3xl font-semibold text-green-400 mb-4">
              Why Choose Us?
            </h2>
            <ul className="text-left list-disc list-inside space-y-2 sm:space-y-3 text-white font-semibold">
              <li>
